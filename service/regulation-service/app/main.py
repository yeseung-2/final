...
logger = logging.getLogger("regulation-service")
...
# ---------- FastAPI ----------
app = FastAPI(title="Regulation Service API", description="Regulation 서비스", version="1.0.0")
...
# ---------- Import Routers ----------
from .router.regulation_router import regulation_router
...
def root():
    return {
        ...
        "endpoints": ["/regulation", "/health", "/metrics"]
    }
